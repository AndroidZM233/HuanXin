 ...
 */
package com.speedata.huanxin.adapter;
...
import com.speedata.huanxin.EaseConstant;
import com.speedata.huanxin.model.EaseChatMessageList;
import com.speedata.huanxin.model.EaseChatRowPresenter;
import com.speedata.huanxin.model.EaseCustomChatRowProvider;
import com.speedata.huanxin.model.EaseMessageListItemStyle;
...
public class EaseMessageAdapter extends BaseAdapter {
    ...
    Handler handler = new Handler() {
        private void refreshList() {
            ...
            java.util.List<EMMessage> var;
            var = conversation.searchMsgFromDB(System.currentTimeMillis(), 1, EMConversation.EMSearchDirection.UP);

            messages = var.toArray(new EMMessage[var.size()]);
//            EMMessage latestMessageFromOthers = conversation.getLastMessage();
//            messages = new EMMessage[]{var.get(var.size() - 1)};
            Log.e(TAG, "数据数量: " + var.size());
